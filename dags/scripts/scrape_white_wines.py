def run():
    ...
    from airflow.hooks.postgres_hook import PostgresHook  # <- also missing in your snippet!
    ...
    def recreate_staging_table(cursor) -> None:
        cursor.execute("""
            DROP TABLE IF EXISTS landing.white_wines CASCADE;
            CREATE UNLOGGED TABLE landing.white_wines (
                id TEXT,
                name TEXT,
                volume DECIMAL,
                abv DECIMAL,
    ...
    def fetch_and_insert_white_wines():
        headers = {
        ...
        with conn.cursor() as cursor:
            ...
            psycopg2.extras.execute_batch(cursor, """
                INSERT INTO landing.white_wines VALUES (
