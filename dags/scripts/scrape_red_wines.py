def run():
    ...
    def recreate_staging_table(cursor) -> None:
        cursor.execute("""
            DROP TABLE IF EXISTS landing.red_wines CASCADE;
            CREATE UNLOGGED TABLE landing.red_wines (
                id TEXT,
                name TEXT,
                volume DECIMAL,
                abv DECIMAL,
    ...
    def fetch_and_insert_red_wines():
        headers = {
        ...
        with conn.cursor() as cursor:
            ...
            psycopg2.extras.execute_batch(
                cursor,
                """
                INSERT INTO landing.red_wines VALUES (
